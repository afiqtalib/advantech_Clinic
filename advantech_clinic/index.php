...
<?php
$sql = "INSERT INTO patient_login_record (patientIc) VALUES ('$icPatient')";
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/alisa.png" height="99px"></a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" style="color: black;" >Register</h3>
                    </div>
                    <!-- modal body start -->
        ...
        <section id="promo-1" class="content-block promo-1 min-height-600px bg-offwhite">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <h2 style="color: black;">Make appointment today!</h2>
                        <p style="color: black;">This is Doctor's Schedule. Please <span class="label label-danger">login</span> to make an appointment. </p>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">©Advantech Dental Clinic</p>
                <p class="pull-right small"><a href="stafflogin.php">Staff</a></p>
            </div>
            <div class="container">
                
                <p class="pull-right small"><a href="adminlogin.php">Dentist</a></p>
            </div>
