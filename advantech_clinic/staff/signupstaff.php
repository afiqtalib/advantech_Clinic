...
{
$icPatient = mysqli_real_escape_string($con,$_POST['icstaff']);
...
$patientFirstName = mysqli_real_escape_string($con,$_POST['staffFirstName']);
$patientLastName  = mysqli_real_escape_string($con,$_POST['staffLastName']);
$patientEmail     = mysqli_real_escape_string($con,$_POST['staffEmail']);
$icPatient     = mysqli_real_escape_string($con,$_POST['icstaff']);
$password         = mysqli_real_escape_string($con,$_POST['password']);
...
//INSERT
$query = " INSERT INTO staff (  icstaff, password, staffFirstName, staffLastName,  staffDOB, staffEmail )
VALUES ( '$icstaff', '$password', '$staffFirstName', '$staffLastName', '$staffDOB', '$staffEmail' ) ";
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <!-- <li><a href="signupstaff.php">Admin</a></li> -->
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    <label class="sr-only" for="icstaff">Email</label>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title">Register Staff</h3>
                    </div>
                    <!-- modal body start -->
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="staffFirstName" value="" class="form-control input-lg" placeholder="First Name" required />
                                            </div>
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="staffLastName" value="" class="form-control input-lg" placeholder="Last Name" required />
                                            </div>
                                        </div>
                                        
                                        <input type="text" name="staffEmail" value="" class="form-control input-lg" placeholder="Your Email"  required/>
                                        <input type="number" name="icstaff" value="" class="form-control input-lg" placeholder="Your IC Number"  required/>
