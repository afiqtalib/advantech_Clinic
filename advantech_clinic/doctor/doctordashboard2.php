            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="addschedule2.php"><i class="fa fa-fw fa-table"></i> Doctor Schedule</a>
                        </li>
                        <li>
                    ...
                    <div class="panel panel-primary filterable">
                       ...
                       <div class="panel-heading">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $res=mysqli_query($con,"SELECT * FROM appointment");
                                  if (!$res) {
                                    printf("Error: %s\n", mysqli_error($con));
                                    exit();
                                }
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                $patid = $appointment['patientIc'];
                                $scheid = $appointment['scheduleId'];

                                $select_patient = mysqli_query($con, "SELECT * FROM patient WHERE icPatient = '$patid'");
                                $patient = mysqli_fetch_array($select_patient);

                                $select_schedule = mysqli_query($con, "SELECT * FROM doctorschedule WHERE scheduleId = '$scheid'");
                                $schedule = mysqli_fetch_array($select_schedule);

                                echo "<tbody>";
                                echo "<tr class='$status'>";
                                    echo "<td>" . $appointment['patientIc'] . "</td>";
                                    echo "<td>" . $patient['patientFirstName'] . "</td>";
                                    echo "<td>" . $patient['patientPhone'] . "</td>";
                                    echo "<td>" . $schedule['doctorname'] . "</td>";
