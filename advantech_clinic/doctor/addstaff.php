...
if(isset($_POST['regbtn'])){
    ...
    $a = mysqli_fetch_assoc($results);
        ...
        $reg= "INSERT INTO staff(icstaff, password, staffFirstName, staffLastName, staffAddress, staffPhone, staffEmail, staffDOB) VALUES ('$IC', '$Pass', '$FName', '$LName', '$Address', '$PhoneNum', '$Email','$DOB')";
