                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-calendar"></i> Staff List
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="staff Ic" disabled></th>
                            ...
                            while ($staffRow=mysqli_fetch_array($result)) {
                                
                              
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $staffRow['icstaff'] . "</td>";
                                    echo "<td>" . $staffRow['staffFirstName'] . "</td>";
                                    echo "<td>" . $staffRow['password'] . "</td>";
                                    echo "<td>" . $staffRow['staffPhone'] . "</td>";
                                    // echo "<td>" . $staffRow['staffEmail'] . "</td>";
                                    
                                     
                                    echo "<td>" . $staffRow['staffDOB'] . "</td>";
                                    echo "<td>" . $staffRow['staffAddress'] . "</td>";
