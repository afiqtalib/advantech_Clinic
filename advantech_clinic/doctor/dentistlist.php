                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-calendar"></i> Dentist List
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">List of Dentist</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($doctorRow=mysqli_fetch_array($result)) {
                                ...
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $doctorRow['doctorId'] . "</td>";
                                    echo "<td>" . $doctorRow['doctorFirstName'] . "</td>";
                                    echo "<td>" . $doctorRow['password'] . "</td>";
