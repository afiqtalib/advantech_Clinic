...
$res2=mysqli_query($con, "SELECT a.*, b.*,c.* FROM patient a
	JOIN appointment b
...
echo "<td>" . $userRow2['patientFirstName'] . "</td>";
echo "<td>" . $userRow2['scheduleDay'] . "</td>";
echo "<td>" . $userRow2['scheduleDate'] . "</td>";
echo "<td>" . $userRow2['startTime'] . "</td>";
echo "<td>" . $userRow2['endTime'] . "</td>";
echo "<td><a href='invoice.php?appid=".$userRow2['appId']."' target='_blank'><span class='glyphicon glyphicon-print' aria-hidden='true'></span></a> </td>";
}
